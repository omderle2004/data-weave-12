      ...
      <Panel defaultSize={45} minSize={10} maxSize={100}>
        <div className="h-full overflow-x-auto">
          <PanelGroup direction="horizontal" className="h-full min-w-fit">
            {/* Input Section - Ask to SmartBiz AI Panel */}
            <Panel defaultSize={35} minSize={20} maxSize={80}>
              <div className="h-full bg-card border-t border-border flex flex-col min-w-[280px]">
                {/* Header */}
            ...
            {/* Output Section - SmartBiz Output Panel */}
            <Panel defaultSize={65} minSize={20} maxSize={80}>
              <div className="h-full border-t border-border min-w-[420px]">
